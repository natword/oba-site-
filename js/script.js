  ...
  document.addEventListener('DOMContentLoaded', function () {
    ...
    var PLACEHOLDER =
      'data:image/svg+xml;charset=utf-8,' + encodeURIComponent(
        ...
        '<text x="400" y="485" text-anchor="middle" font-family="Georgia,serif" font-size="64" font-style="italic" fill="#C9A24B">OBA</text>' +
        '<text x="400" y="700" text-anchor="middle" font-family="Georgia,serif" font-size="26" font-style="italic" fill="#8E97A8">Photo à venir</text>' +
        '</svg>'
      );
